...
var elementosH2 = document.querySelectorAll('.h2.section-header__title--base');
...
elementosUiItem.forEach(function (elemento) {
    ...
    // Adiciona o botão "Comprar" ao elemento pai
    elemento.appendChild(botaoComprar);

    // Adiciona evento de hover
    elemento.addEventListener('mouseover', function () {
        // Aplica animação de fade-in ao botão "Comprar" no hover
        botaoComprar.style.transition = 'opacity 0.3s ease-in-out';
        botaoComprar.style.opacity = '1';
    });

    // Adiciona evento para resetar a opacidade no mouseout
    elemento.addEventListener('mouseout', function () {
        // Reseta a opacidade do botão "Comprar"
